...
const consejoSuperior = [
  ...
  {
    id: 'og-4',
    nombre: 'Ing. Civil Victor Gayoso Tarazona',
    cargo: 'ESPECIALISTA Y EXPERIENCIA EN OBRAS EN CONTRATACIONES CON EL ESTADO',
    pais: 'pe',
...
const principal = computed(() =>
  consejoSuperior.find(p => p.id === 'dir-2')
)

// const principales = computed(() =>
//   consejoSuperior.filter(p => p.id === 'dir-1' || p.id === 'dir-2')
// )
...
<template>
    ...
    <section class="py-12 px-6 bg-gray-50 text-center">
      <div class="max-w-3xl mx-auto">
        ...
        <p class="text-neutral-700 leading-relaxed text-lg">Esta conformado por</p>
      </div>
    </section>
